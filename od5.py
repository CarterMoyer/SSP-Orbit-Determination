...
# my od4 code had some error that I simply could not find after hours of bug hunting
# an error of 3 one thousands in each of my vector's components :c
# with my teammate's (Catherine's) permission, I am utilizing her data to get the correct vector value
